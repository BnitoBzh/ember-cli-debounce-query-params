...
n.debounce(this,this._updateQueryParam,r,i,this.get("debounceQueryParams."+r))},_setupDebounceQueryParams:function(){var e=this.get("debounceQueryParams")
for(var t in e){var n=this._debounceParamName(t)
this.set(n,this.get(t)),this.addObserver(n,this,"_paramUpdate")}},_checkQueryParamsPresence:function(e){var t=this.get("queryParams")
